...
const borderMatch = svg.match(/<rect[^>]*stroke="([^"]+)"/);
const textMatch = svg.match(/<text[^>]*fill="([^"]+)"/);

console.log("bg:", bgMatch?.[1]);
console.log("border:", borderMatch?.[1]);
...
console.log("iconInner:", iconInner);
